            ...
            <main class="main-content">
                ...
                <div class="grid grid-cols-3 mb-6">
                    <div class="report-card-container">
                        <div class="report-icon-wrapper icon-wrapper-green">
                    ...
                    <div class="report-card-container">
                        <div class="report-icon-wrapper icon-wrapper-blue">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="report-card-container">
                        <div class="report-icon-wrapper icon-wrapper-cyan">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Recent Reports -->
                <div class="card">
                    <h3 style="font-size: 16px; font-weight: 600; color: #333; margin-bottom: 16px;">Recent Reports</h3>
                    <div>
